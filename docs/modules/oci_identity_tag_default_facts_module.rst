:source: cloud/oracle/oci_identity_tag_default_facts.py

:orphan:

.. _oci_identity_tag_default_facts_module:
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>A filter to only return resources that match the specified OCID exactly.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
