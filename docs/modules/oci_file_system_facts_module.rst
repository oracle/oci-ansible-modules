:source: cloud/oracle/oci_file_system_facts.py

:orphan:

.. _oci_file_system_facts_module:
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Availability domain from which details of all OCI File System instances must be fetched.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Identifier of the compartment from which details of all OCI File System instances must be fetched</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Identifier of the File System whose details needs to be fetched.</div>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>success</td>
                <td>
                                            <div>Attributes of the fetchedd File System.</div>
                                        <br/>
...
.. hint::
    If you notice any issues in this documentation you can `edit this document <https://github.com/ansible/ansible/edit/devel/lib/ansible/modules/cloud/oracle/oci_file_system_facts.py?description=%23%23%23%23%23%20SUMMARY%0A%3C!---%20Your%20description%20here%20--%3E%0A%0A%0A%23%23%23%23%23%20ISSUE%20TYPE%0A-%20Docs%20Pull%20Request%0A%0A%2Blabel:%20docsite_pr>`_ to improve it.
