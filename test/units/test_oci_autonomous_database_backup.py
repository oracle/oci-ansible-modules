...
try:
    ...
    raise SkipTest(
        "test_autonomous_database_backup.py requires `oci` module")
...
def test_create_autonomous_database_backup(db_client, create_and_wait_patch):
    ...
    create_and_wait_patch.return_value = {'autonomous_database_backup': to_dict(autonomous_database_backup), 'changed': True}
    result = oci_autonomous_database_backup.create_autonomous_database_backup(db_client, module)
    assert result['autonomous_database_backup']['display_name'] is autonomous_database_backup.display_name
