...
def test_list_dhcp_optionss_with_ig_id(virtual_network_client, list_all_resources_patch):
...
def test_list_dhcp_optionss_service_error(virtual_network_client, list_all_resources_patch):
...
def get_module_with_dhcp_id():
    params = {'compartment_id': None,
              'vcn_id': None,
              'dhcp_id': 'ocid.dhcp..fxdv'}
    module = FakeModule(**params)
    return module