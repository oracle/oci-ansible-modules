...
def test_list_security_lists(virtual_network_client, list_all_resources_patch):
    module = get_module(dict({'compartment_id': 'ocid1.compartment.aa',
                              'vcn_id': 'ocid1.vcn.aa', 'security_list_id': ''}))
...
def test_list_security_lists_for_specific_security_list(virtual_network_client, list_all_resources_patch):
    module = get_module(dict({'compartment_id': '',
                              'vcn_id': '', 'security_list_id': 'ocid1.securitylist.aaa'}))
    result = oci_security_list_facts.list_security_lists(
        virtual_network_client, module)
...
def test_list_security_lists_service_error(virtual_network_client, list_all_resources_patch):
