...
try:
    ...
    raise SkipTest(
        "test_oci_file_system.py requires `oci` module")
...
def test_create_or_update_file_system_create(file_storage_client, check_and_create_resource_patch):
    module = get_module()
    file_system = get_file_system()
    check_and_create_resource_patch.return_value = {
        'file_system': to_dict(file_system), 'changed': True}
...
def test_create_or_update_file_system_update(file_storage_client, update_file_system_patch):
...
def test_create_or_update_file_systeme_client_error(file_storage_client, check_and_create_resource_patch):
...
def test_create_or_update_file_systeme_service_error(file_storage_client, check_and_create_resource_patch):
...
def test_create_file_system(file_storage_client, create_and_wait_patch):
    module = get_module()
    file_system = get_file_system()
    create_and_wait_patch.return_value = {'file_system': to_dict(file_system), 'changed': True}
    result = oci_file_system.create_file_system(file_storage_client, module)
    assert result['file_system']['display_name'] is file_system.display_name


def test_update_file_system_display_name(file_storage_client, check_and_update_resource_patch):
    file_system = get_file_system()
...
def test_update_file_system_freeform_tags(file_storage_client, check_and_update_resource_patch):
    file_system = get_file_system()
...
def test_update_file_system_defined_tags(file_storage_client, check_and_update_resource_patch):
    file_system = get_file_system()
...
def test_delete_file_system(file_storage_client, delete_and_wait_patch):
    module = get_module(dict(file_system_id='ocid1.mounttarget.aaa'))
    file_system = get_file_system()
    delete_and_wait_patch.return_value = {'file_system': to_dict(file_system), 'changed': True}
