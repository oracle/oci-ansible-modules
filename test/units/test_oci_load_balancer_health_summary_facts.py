...
import logging
from ansible.modules.cloud.oracle import oci_load_balancer_health_summary_facts
from ansible.module_utils.oracle import oci_utils

try:
    import oci
    from oci.load_balancer.models import LoadBalancerHealthSummary
...
def test_list_load_balancer_healths(lb_client, list_all_resources_patch):
    module = get_module()
