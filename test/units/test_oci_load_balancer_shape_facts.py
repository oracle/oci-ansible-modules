...
try:
    ...
    raise SkipTest(
        "test_oci_load_balancer_shape_facts.py requires `oci` module")
...
def test_list_load_balancer_shapes(lb_client, list_all_resources_patch):
    ...
    result = oci_load_balancer_shape_facts.list_load_balancer_shapes(
        lb_client, module)
...
def test_list_load_balancer_shapes_service_error(lb_client, list_all_resources_patch):
    ...
    try:
        oci_load_balancer_shape_facts.list_load_balancer_shapes(
            lb_client, module)
