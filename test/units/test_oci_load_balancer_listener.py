...
def test_create_or_update_listener_create(lb_client, check_and_create_resource_patch):
    ...
    check_and_create_resource_patch.return_value = {'listener': to_dict(get_listener()), 'changed': True}
...
def test_create_or_update_listener_service_error(lb_client, check_and_create_resource_patch):
