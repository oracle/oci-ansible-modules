...
def delete_public_ip(virtual_network_client, module):
    result = oci_utils.delete_and_wait(resource_type="public_ip",
...
def update_public_ip(virtual_network_client, module):
    result = oci_utils.check_and_update_resource(resource_type="public_ip",
                                                 get_fn=virtual_network_client.get_public_ip,
                                                 kwargs_get={"public_ip_id": module.params["public_ip_id"]},
    ...
    if result['changed']:
        if module.params.get('wait', None):
            response_get = oci_utils.call_with_backoff(virtual_network_client.get_public_ip,
            ...
            result['public_ip'] = to_dict(wait_until(virtual_network_client,
                                                     response_get,
...
def create_public_ip(virtual_network_client, module):
    ...
    result = oci_utils.create_and_wait(resource_type="public_ip",
