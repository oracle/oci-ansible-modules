...
def main():
    ...
    try:
        if ip_sec_connection_id is not None:
            result = [to_dict(oci_utils.call_with_backoff(virtual_network_client.get_ip_sec_connection,
                                                          ipsc_id=ip_sec_connection_id).data)]
        else:
            compartment_id = module.params['compartment_id']
            result = to_dict(oci_utils.list_all_resources(virtual_network_client.list_ip_sec_connections,
