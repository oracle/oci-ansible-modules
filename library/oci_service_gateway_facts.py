...
def main():
    ...
    module = AnsibleModule(
        ...
        required_one_of=[
            ['compartment_id', 'service_gateway_id']
        ]
    )
    ...
    try:
        if service_gateway_id is not None:
            result = [to_dict(oci_utils.call_with_backoff(virtual_network_client.get_service_gateway,
            ...
            result = to_dict(oci_utils.list_all_resources(virtual_network_client.list_service_gateways,
