...
def delete_volume_backup(block_storage_client, module):
    result = oci_utils.delete_and_wait(resource_type="volume_backup",
...
def create_volume_backup(block_storage_client, module):
    ...
    result = oci_utils.create_and_wait(resource_type="volume_backup",
    ...
    if result['volume_backup']['lifecycle_state'] == "FAULTY":
        oci_utils.call_with_backoff(block_storage_client.delete_volume_backup,
...
def update_volume_backup(block_storage_client, module):
    return oci_utils.check_and_update_resource(resource_type="volume_backup",
                                               get_fn=block_storage_client.get_volume_backup,
...
def main():
    ...
    if state == 'absent':
        ...
        if volume_backup_id is None:
            ...
            compartment_id = block_storage_client.get_volume(module.params['volume_id']).data.compartment_id
            result = oci_utils.check_and_create_resource(resource_type='volume_backup',
