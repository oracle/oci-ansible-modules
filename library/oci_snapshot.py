...
def create_or_update_snapshot(file_storage_client, module):
    ...
    try:
        if snapshot_id:
            ...
            result = oci_utils.check_and_create_resource(resource_type='snapshot',
...
def create_snapshot(file_storage_client, module):
    ...
    result = oci_utils.create_and_wait(resource_type='snapshot',
                                       create_fn=file_storage_client.create_snapshot,
                                       kwargs_create={
                                           'create_snapshot_details': create_snapshot_details},
...
def update_snapshot(file_storage_client, module):
    result = oci_utils.check_and_update_resource(resource_type="snapshot",
                                                 get_fn=file_storage_client.get_snapshot,
                                                 kwargs_get={
                                                     "snapshot_id":
...
def delete_snapshot(file_storage_client, module):
    result = oci_utils.delete_and_wait(resource_type='snapshot',
                                       client=file_storage_client,
                                       get_fn=file_storage_client.get_snapshot,
                                       kwargs_get={
