...
def list_load_balancer_healths(lb_client, module):
    ...
    try:
        result['load_balancer_health_summary'] = to_dict(oci_utils.list_all_resources(
            lb_client.list_load_balancer_healths,
            compartment_id=compartment_id))
    except ServiceError as ex:
        get_logger().error("Unable to list all load balancer healths due to: %s", ex.message)
