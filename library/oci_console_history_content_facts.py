...
def main():
    ...
    try:
        ...
        console_history_data = oci_utils.call_with_backoff(compute_client.get_console_history_content,
        ...
        if module.params.get('force') or not os.path.isfile(dest):
            ...
            module.fail_json(msg="Destination file {0} already exists, but force is false and so cannot "
