...
def list_autonomous_databases(db_client, module):
    ...
    try:
        if compartment_id:
            get_logger().debug("Listing all Autonomous Databases under compartment %s", compartment_id)
            ...
            response = oci_utils.call_with_backoff(
                db_client.get_autonomous_database, autonomous_database_id=autonomous_database_id)
...
def main():
    ...
    module = AnsibleModule(
        ...
        mutually_exclusive=[
            ['compartment_id', 'autonomous_database_id']
        ]
    )
