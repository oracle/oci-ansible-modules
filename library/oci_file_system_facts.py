...
def list_file_systems(file_storage_client, module):
    ...
    try:
        if compartment_id and availability_domain:
            get_logger().debug("Listing all File Systems under compartment %s and availability domain %s",
            ...
            existing_file_systems_summary = to_dict(oci_utils.list_all_resources(
                file_storage_client.list_file_systems,
                compartment_id=compartment_id,
                availability_domain=availability_domain,
                **optional_kwargs))
            existing_file_systems = [oci_utils.call_with_backoff(
                file_storage_client.get_file_system, file_system_id=file_system['id']).data
